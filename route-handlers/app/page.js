export default function HomePage() {
  return (
    <div className="max-w-4xl mx-auto bg-white shadow-lg rounded-lg p-6">
      <h1 className="text-3xl font-bold mb-4 text-gray-800">Next.js Route Handlers Learning</h1>
      <p className="mb-6 text-gray-600">
        This project explores various Route Handler concepts using Next.js 15+. 
        All examples are designed to be tested using Postman.
      </p>

      <h2 className="text-2xl font-semibold mb-3 text-blue-600">Available Endpoints (Test with Postman):</h2>
